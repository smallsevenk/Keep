            ...
            child: Column(
              ...
              children: <Widget>[
                Text('- 没有更多了 -',
                    ...
                    style: TextStyle(fontSize: 12, color: Z6Color.deep_kgray)),
              ],
            ))
      ],
    );
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Text(
                          ...
                          style: TextStyle(
                              fontSize: 10, color: Z6Color.light_kgray),
                        ),
                        Expanded(
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.end,
            ...
            children: <Widget>[
              ListTile(
                ...
                trailing: Container(
                  ...
                  child: Image.asset('imgs/explore_class_section_right.png'),
                ),
              ),
              SizedBox(height: 20),
              Container(
