...
import 'package:framework/xm_utils/image_ext.dart';
...
class _TabStyle extends AnimatedWidget {
  ...
  // _xmBuildStyle(Widget child, Color color) {
  //   if (child is MultiChildRenderObjectWidget) {
  //     MultiChildRenderObjectWidget multis = child;
  //     for (Widget c in multis.children) {
  //       if (c is Expanded) {
  //         Expanded exp = c;
  //         Icon(Icons.ac_unit);
  //         if (exp.child is InkWell) {
  //           InkWell ink = exp.child;
  //           if (ink.child is Padding) {
  //             Padding pad = ink.child as Padding;
  //             if (pad.child is Stack) {
  //               Stack stk = pad.child;
  //               _xmBuildStyle(stk, color);
  //             }
  //           }
  //         }
  //       } else if (c is Center) {
  //         Center center = c;
  //         if (center.child is Padding) {
  //           Padding pad = center.child;
  //           if (pad.child is KeyedSubtree) {
  //             KeyedSubtree ks = pad.child;
  //             _xmBuildStyle(ks.child, color);
  //           }
  //         }
  //         if (isPading(center) != null) {}
  //       } else if (c is Image) {
  //         print(1111);
  //         multis.children[0] = c.copy(color: Colors.green);
  //       } else if (c is MultiChildRenderObjectWidget) {
  //         _xmBuildStyle(c, color);
  //       } else if (c is Text) {
  //         Text t = c;
  //         print(t.data);
  //       }
  ...
  // Padding isPading(Widget wid) {
  //   return wid is Padding ? wid : null;
  // }
}
...
class XMTabBar extends StatefulWidget implements PreferredSizeWidget {
...
class _TabBarState extends State<XMTabBar> {
  ...
  @override
  void didUpdateWidget(XMTabBar oldWidget) {
